...
const UI_TEXT_SELECTOR='h1,h2,h3,button,label,dt,th,.eyebrow,.nav-section-label,.muted,.ops-page-heading p,.ops-panel-title p,.ops-note,.ops-setting-card p,.ops-status-strip span,.wv2-panel>h3,.wv2-detail-title,.fast-facts dt,.alert-modal p,.bh-language-switcher span,.bh-language-switcher option';
